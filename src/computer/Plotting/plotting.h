...
public:
    ...
    void plotRun3(std::list<MPCReturn> &log1, std::list<MPCReturn> &log2, std::list<MPCReturn> &log3, const TrackPos &track_xy) const;
    void plotSim3(std::list<MPCReturn> &log1, std::list<MPCReturn> &log2, std::list<MPCReturn> &log3, const TrackPos &track_xy) const;
